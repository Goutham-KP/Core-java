class SportsMania{
	...
	static String bowlers[]={"Lasith Malinga","Dwayne bravo","Yuzi Chahal","Jasprit Bumrah","Vinay Kumar","Dale Steyn","Mitchel Starc","Trent Boult","Mohammed Shami","Harshal Patel"};
	...
	public static void main(String[] cricket){
		...
		System.out.println("The Top 10 IPL Bowlers Are: "+bowlers[0]+" "+bowlers[1]+" "+bowlers[2]+" "+bowlers[3]+" "+bowlers[4]+" "+bowlers[5]+" "+bowlers[6]+" "+bowlers[7]+" "+bowlers[8]+" "+bowlers[9]);
		...
		System.out.println("The TOP ICC Teams : ");
